...
export class MarketPortfolio extends BasePortfolio{
  ...
  async status(){
    ...
    // The dashboard historically rendered candidate.score directly while trading used
    // a separate calibrated score. From V29.3 the visible field is the exact score used
    // by the final BUY decision; the former value remains available as legacy_raw_score.
