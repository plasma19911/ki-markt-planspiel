...
export class MarketPortfolio extends BasePortfolio{
 ...
 async status(){
  ...
  s.risk={...(s.risk||{}),hardLimits:true,budgetOnly:false,positionLimit:V27_RISK_LIMITS.maxSinglePositionPct,holdingLimit:null,automaticScaleUp:false,existingRiskAlerts:riskAlerts,rule:'Finale V27.5-Grenzen gelten nach dem inneren R2-Plan; alte Core-Felder hardLimits=false/positionLimit=null sind nicht die produktive Endregel.'};
