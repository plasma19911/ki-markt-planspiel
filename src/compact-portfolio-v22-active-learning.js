...
// PAPER-TRADING ONLY. V27.3 keeps V27.2 forward learning and adds a deterministic
// post-condition that prevents contradictory or unconfirmed panic loss sells.
export class MarketPortfolio extends BasePortfolio{
 ...
 async status(){
  ...
  s.finalDecisionPolicy={
   enabled:true,version:27.3,paperTradingOnly:true,mode:'SINGLE_AUTHORITATIVE_FINAL_CONTROLLER_PLUS_DETERMINISTIC_LOSS_SELL_INVARIANT',oneFinalActionPerSymbol:true,
   ...
   lossSellInvariant:true,lossSellAgainstBuyerMajorityBlocked:true,shallowLossNeedsIndependentSellerStructure:true,externalHardRiskMayExitImmediately:true,
   ...
   rule:'V27.3 verhindert zusätzlich GUBRA-/SAGILITY-artige Verlustverkäufe: Ein Minus-SELL mit ausdrücklichem EXIT-HOLD, stärkerer Käuferseite oder nur flachem Verlust ohne unabhängige bestätigte Verkäufer-/Strukturinvaliderung wird deterministisch zu HOLD. Echte externe Hard-Risiken und klar bestätigte tiefe Strukturbrüche bleiben sofort verkaufbar.'
  };
