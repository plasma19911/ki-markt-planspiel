...
function watchFrom(entries,meta={},previous=null){
 ...
 // Vorherige Top-Kandidaten stehen absichtlich VOR dem neuen Rohblock. Der Haupt-C#-
 // Agent kann mehr als 480 Rohwerte senden; so bleiben die 32 Fast-Radar-Funde sicher
 // innerhalb des Eingabefensters. Pro Symbol gewinnt danach trotzdem die frischere Messung.
 const candidates=normalizeWideSweepEntries([...previousCandidates,...arr(entries)]);
