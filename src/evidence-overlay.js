...
export function applyEvidenceDiversity(fast,prompt){
  ...
  for(const c of fast.context||[]){
    ...
    // Aktivierung eines leeren Paper-Depots: knapp unter der normalen FAST-Schwelle darf
    // der beste positive Kandidat starten, solange Struktur und harte Sicherheitschecks stimmen.
