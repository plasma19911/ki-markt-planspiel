...
export class MarketPortfolio extends BasePortfolio{
 ...
 async status(){
  ...
  s.missedOpportunityReviewV2={enabled:true,version:2,mode:'CATALYST_GAP_DISCOVERY_AND_RELATIVE_MISS_LEARNING',paperTradingOnly:true,broadCatalystRadar:true,broadCatalystRadarCacheSeconds:90,targetedNewsGapCheckPerDecision:1,targetedGapCacheSeconds:120,crossCandidateCatalystMatching:true,clinicalLongTermBenefitDetection:true,strategicStakeAndWarrantDetection:true,guidanceCatalysts:true,positiveShockPeakChaseBlocked:true,positiveShockRetestRequired:true,missedShockLearningRelativeToTradingDay:true,fixedMissedShockDayPct:null,rule:'Zweite Auswertung des Handelstags: starke Kursbewegung ohne passende News-Erklaerung gilt als Datenluecke. Ein breit gefasster Catalyst-Radar plus genau ein gezielter Gap-Check sucht klinische/regulatorische Meilensteine, Guidance, strategische Beteiligungen/Warrants, Grossauftraege und M&A nach. Positive Schocks werden nicht am Hoch gekauft, sondern als Retest-Watch sichtbar gehalten. Verpasste Schocks werden relativ zur Bewegung des jeweiligen Handelstags gelernt statt ueber eine feste Tages-Prozentgrenze.'};
  if(s.entryResearchPolicy)s.entryResearchPolicy={...s.entryResearchPolicy,todayTradeReviewV1:true,microDipNear20mHighBlocked:true,highDayChaseBlocked:true,reentryNeedsNewStructure:true,catalystGapDiscoveryV2:true};
  ...
  if(s.newsShockPolicy)s.newsShockPolicy={...s.newsShockPolicy,version:2,catalystGapDiscoveryV2:true,broadCatalystRadar:true,targetedGapCheckPerDecision:1,strategicStakeCatalyst:true,missedShockLearningRelativeToTradingDay:true,highImpactTypes:[...new Set([...(s.newsShockPolicy.highImpactTypes||[]),'STRATEGIC_STAKE'])]};
  if(s.profitOptimizer)s.profitOptimizer={...s.profitOptimizer,todayTradeReviewV1:true,deeperDipPreferred:true,noiseSellBlocked:true,reentryNeedsNewStructure:true,continuationCannotBypassMtf:true,catalystGapDiscoveryV2:true};
  if(s.executionModel)s.executionModel={...s.executionModel,todayTradeReviewV1:true,microDipBuyBlocked:true,highChaseBlocked:true,noiseSellBlocked:true,catalystGapDiscoveryV2:true};
  return s;
 }
}
