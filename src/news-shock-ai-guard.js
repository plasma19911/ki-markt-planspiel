...
const NEWS_HEADERS={'accept':'application/rss+xml,application/xml,text/xml,*/*;q=0.7','user-agent':'Mozilla/5.0 (compatible; KI-Markt-Planspiel/CatalystGapV2.2)'};
