...
export class MarketPortfolio extends BasePortfolio{
  ...
  _withPcAgentRecovery(s={}){
    s.pcAgentScanRecovery={enabled:true,version:'31.7.30',mode:'fail-soft-agent-scan+inherited-payload-ingest+dual-host-pc-quotes',...this.__pcAgentScanRecovery,rule:'PC-Heartbeat und Prefetch bleiben aktiv, auch wenn der interne Portfolio-Scan scheitert. Jeder Agent-Scan läuft durch die vollständige vererbte PC-First-/Wide-Sweep-Annahme und schreibt den persistenten letzten erfolgreichen PC-Scan. Der PC-Scanner wiederholt fehlgeschlagene Yahoo-Batches begrenzt über zwei Hosts.'};
