...
export class MarketPortfolio extends BasePortfolio{
 ...
 async status(){
  ...
  s.sourceHealth={...(s.sourceHealth&& !Array.isArray(s.sourceHealth)?s.sourceHealth:{}),globalFreeNews:{updatedAt:news.updatedAt,freeOnly:true,sources:arr(news.sourceHealth),status:arr(news.sourceHealth).some(x=>x.status==='OK')?'OK':'WAITING'}};
