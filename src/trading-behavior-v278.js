...
function exitFamily(reason=''){const r=String(reason);if(/PROFIT EXIT|GEWINNER|WINNER/i.test(r))return'PROFIT';if(/THESIS|INVALIDATION|STRUKTURBRUCH/i.test(r))return'THESIS';if(/CONFIRMED THESIS|CONFIRMED.*EXIT/i.test(r))return'CONFIRMED';return'SOFT'}
...
function normalizeVersion(s=''){return String(s).replace(/FINAL-CONTROLLER V27\.(?:1|2|3|4|5|6|7)/g,'FINAL-CONTROLLER V27.8')}
