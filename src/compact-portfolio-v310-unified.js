...
export class MarketPortfolio extends BasePortfolio{
  ...
  async _buildStatus(includeAudit=true){
    ...
    s.canonicalScorePolicy={...(s.canonicalScorePolicy||{}),version:31.6,canonicalScale:'0-100',oneFinalEntryScorePerSymbolPerScan:true,buyZoneMin:60,dataQualityMin:55,learningMode:canonicalCalibrated?'KALIBRIERT':'WARMUP',legacyScoresDiagnosticOnly:true,expectedNetEdgeAfterCosts:true,missingDataReducesQuality:true,normalizeLegacyTenPointScores:true,scoreScaleLogged:true,rawScannerScale:'0-10-labelled-separately',predictiveForecastScale:'0-100',continuousOutcomeFeedback:true,shadowCandidateCalibration:true,orthogonalEvidenceCalibration:true};
