...
export class MarketPortfolio extends BasePortfolio{
  ...
  async _buildStatus(includeAudit=true){
    ...
    s.runtimeVersion='V31.4';s.liveDecisionVersion='V31.4';s.predictiveLearningVersion='V31.2';s.outcomeLearningVersion='V31.2';s.unifiedDecisionCorePolicy={...policy,brokerMaster:{...(this.__brokerRowsMeta||{})}};s.predictiveLearningPolicy={enabled:true,...learning,insideUnifiedAuthority:true};s.outcomeLearningPolicy={enabled:true,...learning,insideUnifiedAuthority:true};s.shadowLearningPolicy={enabled:true,...(policy.shadowLearning||{}),insideUnifiedAuthority:true};s.expectancyCorePolicy={enabled:true,version:31.4,mode:'inside-unified-capital-velocity+shadow-authority',calibration:policy.shadowLearning?.calibration||null,...policy.expectancy};
    s.architecture={version:'31.4-shadow-calibration+31.3-capital-velocity+31.2-outcome-learning',outerDecisionLayers:1,outerAuthority:'UnifiedDecisionCoreV310',internalDecisionPasses:['V31.2 continuous outcome learning/early entry','V30.9 high-score capital deployment','V31.4 shadow calibration/concentration entry filter','V31.3 capital-velocity exits/rotation/sizing'],removedOuterWrapperStack:['FinalSellAuthorityV308','HighScoreCapitalDeploymentV309','ExpectancyCoreV310-as-separate-wrapper'],legacyExecutionBase:'V30.7 manual controls/anti-churn and lower execution core',persistentDecisionAudit:true,auditStorageKey:UNIFIED_DECISION_CORE_V310.auditStorageKey,persistentPredictiveLearning:true,persistentOutcomeLearning:true,persistentShadowLearning:true,predictiveLearningStorageKey:OUTCOME_LEARNING_V312.storageKey,outcomeLearningStorageKey:OUTCOME_LEARNING_V312.storageKey,shadowLearningStorageKey:policy.shadowLearning?.storageKey||'shadow-learning-v314',stateMergeUsesRawCandidates:true,brokerMasterSource:this.__brokerRowsMeta?.source||'none'};
    ...
    s.canonicalScorePolicy={...(s.canonicalScorePolicy||{}),version:31.4,canonicalScale:'0-100',normalizeLegacyTenPointScores:true,scoreScaleLogged:true,rawScannerScale:'0-10-labelled-separately',predictiveForecastScale:'0-100',continuousOutcomeFeedback:true,shadowCandidateCalibration:true};
