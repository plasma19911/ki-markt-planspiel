...
// V19: Dynamic Dip + Candle Flow + Selective Capital.
...
export class MarketPortfolio extends BasePortfolio{
 ...
 async status(){
  ...
  s.candleFlowPolicy={enabled:true,version:2,mode:'DYNAMIC_BUYER_SELLER_CANDLES',interval:'1m',maxCandleChecksPerScan:5,fixedTakeProfitPct:null,fixedStopForSoftExitPct:null,fixedDipEntryPct:null,sellAgeRule:false,buyRule:'Relative Dips bevorzugen; BUY erst bei Bodenbildung, nachlassendem Verkaufsdruck, Absorption/höheren Tiefs und Käuferübernahme.',holdRule:'Gewinner laufen lassen solange Käuferstruktur intakt bleibt; keine feste Take-Profit- oder Haltedauergrenze.',sellRule:'Normaler SELL erst bei bestätigter Verkäuferübernahme/Topbildung/tieferen Hochs/fallenden Schlusskursen; harte Event-/Stop-/starke Reversal-Risiken bleiben sofort möglich.',foreignFxBuyRequiresRealFx:true};
  ...
  s.profitFirstPolicy={enabled:false,replacedBy:'CANDLE_FLOW_DYNAMIC',fixedProfitTargets:false,fixedSoftExitProfitPct:null,fixedMinimumHoldForProfitExit:null,note:'P/L-Prozent und Haltedauer sind nur Kontext/Telemetrie; der Ausstieg folgt der Kerzen- und Risikostruktur.'};
  ...
  s.balancedAdaptive={...(s.balancedAdaptive||{}),exitTimingMode:'CANDLE_FLOW_DYNAMIC',softSellAbsoluteGraceMinutes:null,normalRotationMinAgeMinutes:null,quickProfitLockMinAgeMinutes:null,quickProfitLockPct:null,minimumNormalSoftExitProfitPct:null,lossRotationAllowed:'ONLY_WHEN_SELLER_FLOW_OR_HARD_RISK',dipFirstV2:true,candleFlowConfirmation:true,alwaysInvested:false,cashAllowed:true};
  if(s.profitOptimizer)s.profitOptimizer={...s.profitOptimizer,profitFirst:false,fixedProfitTargets:false,minimumNormalSoftExitProfitPct:null,normalSoftExitMinAgeMinutes:null,quickProfitLockPct:null,quickProfitLockMinAgeMinutes:null,lossRotationAllowed:'CANDLE_CONFIRMED_ONLY',dipFirstV2:true,dipSelectionMode:'RELATIVE_DYNAMIC',realDipBeatsHighBuy:true,candleFlowConfirmation:true,candleInterval:'1m',foreignFxBuyRequiresRealFx:true,alwaysInvested:false,capitalInMotion:false,legacyFullCashFailsafe:'BLOCKED_BY_SELECTIVE_CAPITAL',timeBasedExit:false,maxSingleNewPositionRiskCapPct:28};
  if(s.executionModel)s.executionModel={...s.executionModel,profitFirst:false,fixedProfitTargets:false,normalSoftExitMinProfitPct:null,exitTiming:'CANDLE_FLOW_DYNAMIC',candleFlowConfirmation:true,foreignFxBuyRequiresRealFx:true,cashMayRemain:true,fullCashPolicy:false,capitalInMotion:false,forcedMinimumBuyPct:null,timeBasedSell:false};
  return s;
 }
}
