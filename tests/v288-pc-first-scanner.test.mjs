...
assert.match(src,/scorePipeline:'ALL_RECEIVED_PRE_SCORE_0_100 → TOP400 → DEEP240 → FINAL60 → CLOUDFLARE18 \+ POSITIONS'/);
...
console.log(JSON.stringify({ok:true,version:29.2,mode:'CSHARP_PC_FIRST_FULL_MASTER',allReceivedPreScored:true,stage2:400,deep:240,final:60,cloudflareValidation:18,forwardReserve:4,noFirst1000Truncation:true,runtimeImportAvoided:true},null,2));
