...
assert.ok(changelog.includes('50–52 beobachten'),'V29.x muss die Beobachtungszone dokumentieren');
assert.ok(changelog.includes('53–55 Scout'),'V29.x muss Scout ab 53 dokumentieren');
assert.ok(changelog.includes('56–57 Mikro'),'V29.x muss Mikro ab 56 dokumentieren');
assert.ok(changelog.includes('58–61 früher Einstieg'),'V29.x muss frühen Einstieg ab 58 dokumentieren');
