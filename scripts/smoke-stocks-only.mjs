...
// Die aktuelle UI benutzt keine alte Badge-Wortwahl "Nur Aktien" mehr. Die sichtbaren
// Kernflächen sind aber eindeutig aktienbezogen; ETF/Hebel werden oben im produktiven
// Startpfad und Gebührenmodell zusätzlich hart ausgeschlossen.
