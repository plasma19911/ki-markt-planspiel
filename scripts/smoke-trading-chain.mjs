...
const fast={
  actions:[
    ...
    {symbol:'RISK.DE',action:'BUY',confidence:.88,allocation_pct:20,reason:'FAST-BUY: nominell stark',fastScore:5.8}
  ],
  context:[
...
// Evidence + Kosten + Live-Lernen wie im produktiven V5-Pfad.
const evidence=applyEvidenceDiversity(fast,prompt);
// RISK hat zwar den höchsten Roh-Scanner-Score, darf wegen harter Gap-Sperre nicht als
// qualifizierter Ersatz-BUY entstehen. Der nachgelagerte Guard blockiert ihn zusätzlich.
...
// Generative KI liefert nur HOLD: deterministischer Layer muss den besten validierten BUY wählen.
...
// Ein hoher Score darf harte Sicherheit niemals überstimmen.
