...
function normalizeCurrentChangelog(){
 ...
 const live=list.querySelector('[data-v300-changelog]')||list.querySelector('[data-current-changelog]');
 if(live){list.prepend(live);live.classList.add('latest')}
 list.dataset.changelogMaster='v30.0';
}
...
window.__CHANGELOG_MASTER_V290__={version:30.0,keepsLegacyHistory:true,currentAlwaysFirst:true,loadsV292ToV300:true,liveEntry:true};
