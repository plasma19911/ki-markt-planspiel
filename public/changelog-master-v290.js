// V29.0 changelog order hardening.
...
function normalizeCurrentChangelog(){
 ...
 list.dataset.changelogMaster='v29.0';
}
...
window.__CHANGELOG_MASTER_V290__={version:29.0,keepsLegacyHistory:true,currentAlwaysFirst:true};
