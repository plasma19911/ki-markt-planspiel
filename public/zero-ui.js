...
function keepExecutionText(){
 ...
 const text='ZERO Aktien: ganze Wertpapierorder ab 500 € = 0 € Brokergebühr · unter 500 € = 1 € Mindermengenzuschlag · Aktien-Bruchstückauftrag = 1 € separat · Spread/Marktausführung separat.';
...
function ensure(){
 ...
 <div id="zeroBrokerMeta" class="trendSummary">Das Planspiel handelt ausschließlich Aktien aus einem breiten ZERO/gettex-orientierten Aktienuniversum.</div>
...
async function load(){
 ...
 try{
  ...
  const catalog=b.exactBrokerCatalog?'Broker-Katalog exakt synchronisiert':'Breiter Aktien-Kandidatenpool; konkrete ZERO-Handelbarkeit/ISIN muss vor jeder späteren Echtgeldorder über einen offiziellen Broker-/Partnerweg bestätigt werden';
