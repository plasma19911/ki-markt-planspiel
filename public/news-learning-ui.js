...
document.addEventListener('DOMContentLoaded',()=>{ensureFeed();ensureChartModal()});
if(document.readyState!=='loading'){ensureFeed();ensureChartModal()}
